...
class MHCBindingPredictions:
    ...
    def tool_location(self, allele, peplength):
        return("/home/j/Desktop/netMHC/iedb/tool_data/MHCII/%s/%s-%s" %(self.method, allele, peplength))
        
    def comblib_tool_location(self, allele, peplength):
        return("/home/j/Desktop/netMHC/iedb/tool_data/MHCII/%s/%s-%s" %(self.method, allele, peplength))
        
    def consensus_tool_location(self, allele, peplength, method):
        return("/home/j/Desktop/netMHC/iedb/tool_data/MHCII/%s/%s-%s" %(method, allele, peplength))

    def consensus_perc_location(self, allele,  method):
        return("/home/j/Desktop/netMHC/iedb/tool_data/MHCII/%s/perc_%s" %(method, allele))
    ...
    def predict(self,proteins):
        ...
        if self.method=="consensus3":
            con_status = {}
            con_list = open("/home/j/Desktop/netMHC/iedb/tool_data/MHCII/consensus/consensus_allele_list.txt").read().strip().split("\n")
